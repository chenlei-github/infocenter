...
$client->setClientId($configs['GOOGLE_OAUTH_CLIENT_ID']);
$client->setClientSecret($configs['GOOGLE_OAUTH_CLIENT_SECRET']);
$client->setRedirectUri('http://' . $_SERVER['SERVER_NAME'] . '/google-auth/login.php');
