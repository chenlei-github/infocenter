...
def parse_args():
    ...
    """
    admob_task = config.admob_task_list.keys()
    ...
    parser.add_argument("--task", type=str, dest="task", required=True, choices=admob_task, help="")
...
def main():
    ...
    admob_task_config = config.admob_task_list[task_type]
    detail_log_file = admob_task_config["detail_log_file"]
    app["statics_log_file"] = admob_task_config["statics_log_file"]
    clean_sql_file = admob_task_config["clean_sql_file"]
    split_task = admob_task_config["split_task"]
